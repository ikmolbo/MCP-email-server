...
- [ ] 3.6. Improve thread context extraction
- [ ] 3.7. Optimize cache for quick responses
- [ ] 3.8. Enhanced input validations
...
### 1.3 Features pentru îmbunătățirea experienței utilizatorului
- [x] Suport pentru gestionarea etichetelor Gmail
  - [x] Listarea, crearea, actualizarea și ștergerea etichetelor
  - [x] Aplicarea/eliminarea etichetelor pe mesaje
  - [x] Marcarea ca citit/necitit, arhivare/dezarhivare, trimitere în coșul de gunoi
- [x] Configurare fus orar
  - [x] Setare fus orar prin variabilă de mediu sau fișier de configurare
  - [x] Afișarea și procesarea corectă a datelor conform fusului orar configurat
- [ ] Îmbunătățire cache-uire thread-uri
- [ ] Îmbunătățire răspunsuri cu posibilitatea de a folosi quote-uri din email-ul original
